# 12 - Harvesting and Dehydration

*Note: This is a standard baseline protocol. Edit these settings based on your specific dehydrator model.*

## Harvesting
1.  Mushrooms are ready to harvest when the veil underneath the cap begins to tear away from the stem.
2.  Wash and sterilize your hands or wear gloves.
3.  Grasp the mushroom as close to the substrate as possible. Gently twist and pull to release it from the coco coir without tearing up large chunks of the substrate.
4.  Use a soft brush or a scalpel to scrape away any remaining coco coir attached to the bottom of the stem.
