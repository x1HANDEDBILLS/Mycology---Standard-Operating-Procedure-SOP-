...
2.  Add **1 Tablespoon of Light Corn Syrup**. (Alternatively, you can use 1 gram of LME).
...
4.  Vent for 10 minutes, apply the weight, and pressure cook on low for **20 minutes @ 15 psi**.
    * *Warning: Do not pressure cook LC for longer than 20 minutes, or the sugars will caramelize, turn dark brown, and ruin the nutrients.*
5.  Let depressurize naturally and allow the jar to cool completely to room temperature before use.
